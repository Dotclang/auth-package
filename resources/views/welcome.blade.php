...
<head>
    ...
    <link rel="stylesheet" href="{{ class_exists(\Illuminate\Support\Facades\Vite::class)
...
<body class="antialiased bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <script src="{{ class_exists(\Illuminate\Support\Facades\Vite::class)
        ? Vite::asset('resources/js/app.js')
        : asset('vendor/Dotclang/auth-package/js/app.js') }}" defer></script>
</body>
</html>
